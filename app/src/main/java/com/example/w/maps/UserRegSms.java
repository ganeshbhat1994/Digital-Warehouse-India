...
public class UserRegSms extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_reg_sms);
       ...
       Bundle bundle=this.getIntent().getExtras();
        ...
        if (!isOnline(getApplicationContext())) {
            Toast.makeText(UserRegSms.this, "No network connection", Toast.LENGTH_SHORT).show();
            return;
        } else {
    ...
    class loginAccess extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String file_url) {
            ...
            if(flag==1){
                ...
                Toast.makeText(UserRegSms.this, "Please Enter Correct informations", Toast.LENGTH_SHORT).show();
            }

            else{
                textView.setText("SMS Sent :)");
                Toast.makeText(UserRegSms.this,"SMS sent", Toast.LENGTH_SHORT).show();
